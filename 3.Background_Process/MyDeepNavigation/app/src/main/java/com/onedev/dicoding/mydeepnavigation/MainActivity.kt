package com.onedev.dicoding.mydeepnavigation
...
import com.onedev.dicoding.mydeepnavigation.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showNotification(context: Context, title: String, message: String, notifyId: Int) {
        ...
        val pendingIntent = TaskStackBuilder.create(this)
            ...
            .addNextIntent(notifyDetailIntent)
